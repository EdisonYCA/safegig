...
export default function ActionButtons(){
    const actionBtns = [
        { name: 'Home', icon: "/home-3.svg", href: '#', colors: "bg-white text-black col-span-2" },
        { name: 'Find Work',icon: null, href: '#', colors: "bg-blue-green text-white col-span-2" },
        { name: 'Find Jobs', icon: null, href: '#', colors: "bg-prussian-blue text-white col-span-2"},
        { name: 'Post Work', icon: null, href: '#', colors: "bg-selective-yellow text-prussian-blue col-span-2"},
        { name: 'Post Job', icon: "/48-s-add.svg", href: '#', colors: "bg-white text-black col-span-2" },
    ]
